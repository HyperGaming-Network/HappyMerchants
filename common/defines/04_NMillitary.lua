...
NDefines.NMilitary.SAILOR_MAINTAINANCE = 0.01					-- default 0.02
NDefines.NMilitary.HEAVY_SHIP_SAILORS_COST = 2000				-- 1 = 1000 men in cost. 500/10
NDefines.NMilitary.LIGHT_SHIP_SAILORS_COST = 250				-- 1 = 1000 men in cost. 100/2
NDefines.NMilitary.GALLEY_SHIP_SAILORS_COST = 400				-- 1 = 1000 men in cost. 200/4
NDefines.NMilitary.TRANSPORT_SHIP_SAILORS_COST = 100				-- 1 = 1000 men in cost. 50/1

NDefines.NMilitary.HEAVY_SHIP_COST = 100 						-- _MDEF_HEAVY_SHIP_COST = 50
NDefines.NMilitary.LIGHT_SHIP_COST = 30 						-- _MDEF_LIGHT_SHIP_COST = 30
NDefines.NMilitary.GALLEY_COST = 14 							-- _MDEF_GALLEY_COST = 14
NDefines.NMilitary.TRANSPORT_COST = 10							-- _MDEF_TRANSPORT_COST = 10

NDefines.NMilitary.HEAVY_SHIP_TIME = 1460 						-- _MDEF_HEAVY_SHIP_TIME = 730
NDefines.NMilitary.LIGHT_SHIP_TIME = 545 						-- _MDEF_LIGHT_SHIP_TIME = 545
NDefines.NMilitary.GALLEY_TIME = 365 							-- _MDEF_GALLEY_TIME = 365
NDefines.NMilitary.TRANSPORT_TIME = 275 						-- _MDEF_TRANSPORT_TIME = 275
NDefines.NMilitary.MONTHLY_REPAIR = 0.04						-- Ship repair speed.

NDefines.NMilitary.HEAVY_SHIP_SPEED = 5.0						-- _MDEF_HEAVY_SHIP_SPEED = 4,
NDefines.NMilitary.LIGHT_SHIP_SPEED = 7.0						-- _MDEF_LIGHT_SHIP_SPEED = 6.5,
NDefines.NMilitary.GALLEY_SPEED = 5.0							-- _MDEF_GALLEY_SPEED = 4,
NDefines.NMilitary.TRANSPORT_SPEED = 5.0						-- _MDEF_TRANSPORT_SPEED = 4,

NDefines.NMilitary.TRADITION_GAIN_NAVAL = 60					-- Tradition gain base value from naval combat. = 45
...
NDefines.NMilitary.INF_LOOT = 0.45								-- How many ducats/month will a single full strength infantry regiment loot?
NDefines.NMilitary.CAV_LOOT = 1.6								-- How many ducats/month will a single full strength cavalry regiment loot?
NDefines.NMilitary.ART_LOOT = 0.1							-- How many ducats/month will a single full strength artillery regiment loot?
...
NDefines.NMilitary.REBEL_LEADER_POWER = 14						-- The higher this value the more pips rebel leaders will have on average
...
NDefines.NMilitary.ASSAULT_WIDTH_LIMIT = 5				-- default 5 How many times the garrison size that can effectively assault at the same time.
NDefines.NMilitary.ASSAULT_ATTACKER_LOSS = 1.0				-- default 1
NDefines.NMilitary.ASSAULT_DEFENDER_LOSS = 0.10				-- default 0.05
NDefines.NMilitary.ASSAULT_DICE_MODIFIER = 5				-- default 5
