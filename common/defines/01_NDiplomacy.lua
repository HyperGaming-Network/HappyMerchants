...
NDefines.NDiplomacy.AE_SAME_RELIGION = 0.3
...
NDefines.NDiplomacy.AE_ATTACKER_DEVELOPMENT = 0.015								-- +75% cap (at 1000 development)
NDefines.NDiplomacy.AE_DEFENDER_DEVELOPMENT = 0.015								-- -75% cap (at 1000 development)
NDefines.NDiplomacy.AE_DISTANCE_BASE = 0.75										-- higher means MORE reduction. Lower means less.
NDefines.NDiplomacy.AE_PROVINCE_CAP = 40										-- Province development above this will not count for AE, nor will it count for coring cost or warscore.
...
NDefines.NDiplomacy.ANNEX_DIP_COST_PER_DEVELOPMENT = 5							-- per development { was 6 }
