...
NDefines.NCountry.MONTHS_TO_CORE_MAXIMUM = 60						-- 1.21 = 600
NDefines.NCountry.MONTHS_TO_CORE = 60								-- How many months it will take to core a province, 1.21 = 600
...
NDefines.NCountry.LAND_FORCELIMIT_EXTRA_COST_FACTOR = 0.2				--The resulting maintenance is ( num of regiments above force limit * FACTOR + force limit ) / force limit
NDefines.NCountry.NAVAL_FORCELIMIT_EXTRA_COST_FACTOR = 0.0			--If you change the values to 1, being at 200% force limit will result in +100% multiplicative maintenance increase for every unit. If you change the values to 5, being at 200% will result in +500% maintenance