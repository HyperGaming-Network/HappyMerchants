...
NDefines.NEconomy.EMBARGO_BASE_EFFICIENCY = 0.75				-- EMBARGO_BASE_EFFICIENCY
...
NDefines.NEconomy.PIRATES_TRADE_POWER_FACTOR = 1.0
...
NDefines.NEconomy.TRADED_FRACTION_FOR_BONUS = 0.30 -- 200% required trade control of a trade good makes it impossible to obtain the "Trading in <trade good>" bonus.
